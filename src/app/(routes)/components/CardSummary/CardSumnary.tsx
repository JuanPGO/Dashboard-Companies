...
function CardSumnary(props: CardSummaryProps) {
    const { average, icon: Icon, title, tooltipText, total } = props
    return (
        <div className='shadow-sm bg-background rounded-lg p-5 py-3 hoover:shadow-lg transition'>
